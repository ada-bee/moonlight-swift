...
// stored in the socket's receive buffer. A smaller bound
// keeps less data queued in the kernel on this fixed target
// setup while still leaving room for brief packet bursts.
